...
var $author$project$Main$Model = F3(
	function (iorin, deltaIorin, upgrade) {
		return {deltaIorin: deltaIorin, iorin: iorin, upgrade: upgrade};
	});
...
var $author$project$Main$decoder = A4(
	...
	A2(
		...
		'iorin',
		A2($elm$json$Json$Decode$map, $author$project$Main$fromStr, $elm$json$Json$Decode$string)),
	A2(
		$elm$json$Json$Decode$field,
		'deltaIorin',
		A2($elm$json$Json$Decode$map, $author$project$Main$fromStr, $elm$json$Json$Decode$string)),
...
var $author$project$Main$init = function (flags) {
	var initModel = function () {
		...
		if (_v0.$ === 'Ok') {
			...
			return {
				deltaIorin: $author$project$Main$zero,
				iorin: $author$project$Main$zero,
				upgrade: A2($elm$core$Array$repeat, 4, 0)
			};
		}
	}();
		...
		_List_fromArray(
			[
				...
				$elm$json$Json$Encode$string(
					$cmditch$elm_bigint$BigInt$toString(model.iorin))),
				_Utils_Tuple2(
				'deltaIorin',
				$elm$json$Json$Encode$string(
					$cmditch$elm_bigint$BigInt$toString(model.deltaIorin))),
				_Utils_Tuple2(
				'upgrade',
				$elm$json$Json$Encode$array($elm$json$Json$Encode$int)(model.upgrade))
			]));
};
var $author$project$Main$setLocalStorage = _Platform_outgoingPort('setLocalStorage', $elm$core$Basics$identity);
...
var $author$project$UpgradeData$cost = F2(
	function (n, level) {
		switch (n) {
			case 0:
			...
			case 1:
				return A2(
					...
					A2(
						...
						$cmditch$elm_bigint$BigInt$fromInt(5),
						$cmditch$elm_bigint$BigInt$fromInt(level)));
			case 2:
				return A2(
					$cmditch$elm_bigint$BigInt$pow,
					$cmditch$elm_bigint$BigInt$fromInt(10),
					$cmditch$elm_bigint$BigInt$fromInt(level + 2));
			case 3:
				return A2(
					$cmditch$elm_bigint$BigInt$pow,
...
var $author$project$UpgradeData$updateDelta = F4(
	function (n, level, oldDelta, arr) {
		return _Utils_Tuple2(
			function () {
				switch (n) {
					case 0:
...
var $author$project$UpgradeData$updateIorin = F4(
	function (n, level, oldIorin, arr) {
		switch (n) {
			case 0:
				return _Utils_Tuple2(
					A2(
					...
					arr);
			case 1:
				return _Utils_Tuple2(oldIorin, arr);
			case 2:
				return _Utils_Tuple2(oldIorin, arr);
			case 3:
				return _Utils_Tuple2(
...
var $author$project$Main$update = F2(
	function (msg, model) {
		if (msg.$ === 'Pressed') {
			var n = msg.a;
			var upgradeLevel = A2($author$project$Main$get, n, model.upgrade);
			var current = A2(
				$cmditch$elm_bigint$BigInt$sub,
				model.iorin,
				A2($author$project$UpgradeData$cost, n, upgradeLevel));
			if (A2($cmditch$elm_bigint$BigInt$gte, current, $author$project$Main$zero)) {
				var _v1 = A4($author$project$UpgradeData$updateDelta, n, upgradeLevel + 1, model.deltaIorin, model.upgrade);
				var newDelta = _v1.a;
				var updatedArr = _v1.b;
				var _v2 = A4($author$project$UpgradeData$updateIorin, n, upgradeLevel + 1, current, updatedArr);
				var newIorin = _v2.a;
				var newArr = _v2.b;
				return _Utils_Tuple2(
					A3(
						...
						newIorin,
						newDelta,
						A3($elm$core$Array$set, n, upgradeLevel + 1, newArr)),
			...
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						iorin: A2($cmditch$elm_bigint$BigInt$add, model.iorin, model.deltaIorin)
					}),
				$elm$core$Platform$Cmd$none);
		}
	});
	...
	function (msg, oldModel) {
		...
		return _Utils_Tuple2(
			...
			$elm$core$Platform$Cmd$batch(
				_List_fromArray(
					[
						$author$project$Main$setLocalStorage(
...
var $author$project$UpgradeData$description = F2(
	function (n, level) {
		switch (n) {
			case 0:
				return 'Iorin ++';
			case 1:
				return 'Delta ++   / cost : ' + ($cmditch$elm_bigint$BigInt$toString(
					A2($author$project$UpgradeData$cost, n, level)) + (' / level : ' + $elm$core$String$fromInt(level)));
			case 2:
				return 'Delta += 10/ cost : ' + ($cmditch$elm_bigint$BigInt$toString(
					A2($author$project$UpgradeData$cost, n, level)) + (' / level : ' + $elm$core$String$fromInt(level)));
			case 3:
				return 'Iorin * 2  / cost : ' + ($cmditch$elm_bigint$BigInt$toString(
					A2($author$project$UpgradeData$cost, n, level)) + (' / level : ' + $elm$core$String$fromInt(level)));
			case 4:
...
var $author$project$Main$viewButtons = function (arr) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		A2(
						...
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text(
									A2(
										$author$project$UpgradeData$description,
										n,
										A2($author$project$Main$get, n, arr)))
								]))
						]));
			},
...
var $author$project$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$text(
				$cmditch$elm_bigint$BigInt$toString(model.iorin) + ' Iorins'),
				A2($elm$html$Html$br, _List_Nil, _List_Nil),
				$elm$html$Html$text(
				$cmditch$elm_bigint$BigInt$toString(model.deltaIorin) + ' deltaIorin'),
				$author$project$Main$viewButtons(model.upgrade)
			]));
};
